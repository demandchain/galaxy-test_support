...
describe Galaxy::TestSupport::PrettyFormatter do
  ...
  it "formats an implied hash" do
    format_value = "#<GalaxyDbInjector::Deal id: 1, slug: \"6ff445f3\", type: \"daily-deal\">"
    pretty       = Galaxy::TestSupport::PrettyFormatter.format_string(format_value)

    expect(pretty).to be == "#<GalaxyDbInjector::Deal\n  id: 1,\n  slug: \"6ff445f3\",\n  type: \"daily-deal\"\n>"

    format_value = "".html_safe + "#<GalaxyDbInjector::Deal id: 1, slug: \"6ff445f3\", type: \"daily-deal\">"
    pretty       = Galaxy::TestSupport::PrettyFormatter.format_string(format_value)
  ...
  #     @seed_value = 636398616406161937124978872917622596442
  #     puts("@seed_value = #{@seed_value}")
  #     srand(@seed_value)
  #
  #     # test_value, expected_value = create_value(0, [:class, :embedded_class, :implied_hash, :parameters].sample)
  #     test_value, expected_value = create_value(0, [:parameters].sample)
  #     pretty                     = Galaxy::TestSupport::PrettyFormatter.format_string(test_value)
  #     expect(pretty).to be == expected_value
  #   end
  #
