module Galaxy
  module TestSupport
    class ConfiguredReport
      ...
      #   Galaxy::TestSupport::CapybaraDiagnostics.output_page_detail_section.
      ...
      def export_field_record(export_field, parent_object, parent_object_name, report, report_table, level, options = {})
        ...
        if (options.delete(:report_object_set))
          ...
          if parent_object_name == :instance_variables
            report_object = parent_object.instance_variable_get("@#{export_field[level]}")
          else
            ...
            case export_field[level]
              when :instance_variables
                if expand_variable?(export_field[0..-2], export_field[-1]) &&
                  ...
                  instance_table = Galaxy::TestSupport::DiagnosticsReportBuilder::ReportTable.new
                else
                ...
                report_object.instance_variable_names.each do |variable_name|
                  ...
                  unless exclude_variable?(export_field, symbol_name)
                    instance_object = report_object.instance_variable_get(variable_name)
              ...
              when :capybara_diagnostics
                Galaxy::TestSupport::CapybaraDiagnostics.output_page_detail_section(options[:diagnostics_name] || "Capybara Diagnostics",
                                                                                    report,
                                                                                    report_table)
